...
Counterpart to ``direct_ci_krylov.py`` which uses classical exact
matrix exponential.  Enables direct comparison of Krylov basis
generators: exact e^{-iHt} vs Trotterized exp_pauli circuits.
"""
...
def main() -> None:
    ...
    print(f"\n{'=' * 60}")
    print("QUANTUM CIRCUIT SKQD RESULTS")
    print(f"{'=' * 60}")
    ...
    print(f"\nBest energy  : {result.energy:.10f} Ha")
