"""Iterative NQS + DCI+PT2 seed -> SQD diagonalisation.
...
Pipeline:
  ...
  Phase 3: Report best energy across DCI+PT2 seed and iterative NQS+SQD.
...
def main() -> None:
    ...
    # --- Results summary ---
    print("\n" + "=" * 60)
    print("ITERATIVE NQS + DCI+PT2 -> SQD RESULTS")
    print("=" * 60)
    print(f"DCI+PT2 energy   : {dci_energy:.10f} Ha  (basis: {dci_pt2_basis.shape[0]})")
    print(f"NQS+SQD energy   : {nqs_result.energy:.10f} Ha  (basis: {nqs_result.diag_dim})")
